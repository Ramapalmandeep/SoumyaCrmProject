...
public class TabLib {
	...
	/**
	 * It is used to display the option present at right portion of the application
	 */
	...
	/**
	 *  It is used to display the option present at left portion of the application
	 */
