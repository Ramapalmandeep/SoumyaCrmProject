...
public class ExcelLib {
	 ...
	 * @param sName Sheet Name of the Excel sheet
	 * @param rowNum Row Number of the Excel sheet
	 * @param colNum Column Number of the Excel sheet
	 ...
	 * @param rowNum Row Number of the Excel sheet
	 * @param colNum Column Number of the Excel sheet
	 * @param data Data to Input to the Excelsheet
	 * @throws IOException 
	 * @throws InvalidFormatException 
	 * @throws EncryptedDocumentException
	 *  
